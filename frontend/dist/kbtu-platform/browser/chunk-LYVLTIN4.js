...
// src/app/shared/components/subject-card/subject-card.component.ts
var _c02 = (a0) => ["/subjects", a0];
var SubjectCardComponent = class _SubjectCardComponent {
  constructor() {
    this.subject = input.required();
  }
  static {
    this.\u0275fac = function SubjectCardComponent_Factory(t) {
      return new (t || _SubjectCardComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SubjectCardComponent, selectors: [["app-subject-card"]], inputs: { subject: [InputFlags.SignalBased, "subject"] }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 12, vars: 10, consts: [[1, "scard", "card", 3, "routerLink"], [1, "scard__header"], [1, "scard__title"], [1, "text-muted", "scard__credits"], [1, "scard__diff"], [1, "text-muted", "scard__diff-label"], [3, "value"]], template: function SubjectCardComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "a", 0)(1, "div", 1)(2, "h3", 2);
        \u0275\u0275text(3);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275element(11, "app-difficulty-bar", 6);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(8, _c02, ctx.subject().id));
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(ctx.subject().title);
        \u0275\u0275advance();
        \u0275\u0275classMapInterpolate1("badge badge--", ctx.subject().category, "");
        \u0275\u0275advance();
        \u0275\u0275textInterpolate(ctx.subject().category);
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate1("", ctx.subject().credits, " credits");
        \u0275\u0275advance(4);
        \u0275\u0275property("value", ctx.subject().overall_difficulty);
      }
    }, dependencies: [CommonModule, RouterLink, DifficultyBarComponent], styles: ["\n\n.scard[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n  padding: 18px 20px;\n  text-decoration: none;\n  color: var(--color-text);\n  transition: transform 180ms ease;\n}\n.scard[_ngcontent-%COMP%]:hover {\n  transform: translateY(-3px);\n  text-decoration: none;\n}\n.scard__header[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: flex-start;\n  justify-content: space-between;\n  gap: 8px;\n}\n.scard__title[_ngcontent-%COMP%] {\n  font-size: 0.95rem;\n  font-weight: 600;\n  margin: 0;\n  line-height: 1.35;\n}\n.scard__credits[_ngcontent-%COMP%] {\n  font-size: 0.8rem;\n}\n.scard__diff[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n}\n.scard__diff-label[_ngcontent-%COMP%] {\n  font-size: 0.75rem;\n}\n.badge[_ngcontent-%COMP%] {\n  font-size: 0.68rem;\n  padding: 2px 8px;\n  border-radius: 20px;\n  font-weight: 600;\n  white-space: nowrap;\n  text-transform: capitalize;\n  flex-shrink: 0;\n}\n.badge--mandatory[_ngcontent-%COMP%] {\n  background: #e3f2fd;\n  color: #1565c0;\n}\n.badge--elective[_ngcontent-%COMP%] {\n  background: #f3e5f5;\n  color: #6a1b9a;\n}\n.badge--major[_ngcontent-%COMP%] {\n  background: #e8f5e9;\n  color: #2e7d32;\n}\n.badge--minor[_ngcontent-%COMP%] {\n  background: #fff3e0;\n  color: #e65100;\n}\n.badge--profile[_ngcontent-%COMP%] {\n  background: #fce4ec;\n  color: #880e4f;\n}\n.dark-theme[_ngcontent-%COMP%]   .badge--mandatory[_ngcontent-%COMP%] {\n  background: #1a3a5c;\n  color: #90caf9;\n}\n.dark-theme[_ngcontent-%COMP%]   .badge--elective[_ngcontent-%COMP%] {\n  background: #3a1a5c;\n  color: #ce93d8;\n}\n.dark-theme[_ngcontent-%COMP%]   .badge--major[_ngcontent-%COMP%] {\n  background: #1a3a1c;\n  color: #a5d6a7;\n}\n.dark-theme[_ngcontent-%COMP%]   .badge--minor[_ngcontent-%COMP%] {\n  background: #3a2a0a;\n  color: #ffcc80;\n}\n.dark-theme[_ngcontent-%COMP%]   .badge--profile[_ngcontent-%COMP%] {\n  background: #3a0a1a;\n  color: #f48fb1;\n}\n/*# sourceMappingURL=subject-card.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SubjectCardComponent, { className: "SubjectCardComponent", filePath: "src\\app\\shared\\components\\subject-card\\subject-card.component.ts", lineNumber: 14 });
})();

// src/app/features/subjects/subject-list/subject-list.component.ts
var _forTrack0 = ($index, $item) => $item.id;
var _c03 = () => [10, 20, 50];
function SubjectListComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("(", ctx_r0.total(), ")");
  }
}
function SubjectListComponent_For_11_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 9);
    \u0275\u0275listener("click", function SubjectListComponent_For_11_Template_button_click_0_listener() {
      const cat_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.selectCategory(cat_r3));
    });
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "titlecase");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275classProp("slist__tab--active", ctx_r0.activeCategory() === cat_r3);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 3, cat_r3), " ");
  }
}
function SubjectListComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-loading-spinner");
  }
}
function SubjectListComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 10)(1, "mat-icon");
    \u0275\u0275text(2, "search_off");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p");
    \u0275\u0275text(4, "No subjects found.");
    \u0275\u0275elementEnd()();
  }
}
function SubjectListComponent_Conditional_14_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-subject-card", 12);
  }
  if (rf & 2) {
    const s_r5 = ctx.$implicit;
    \u0275\u0275property("subject", s_r5);
  }
}
function SubjectListComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 11);
    \u0275\u0275repeaterCreate(1, SubjectListComponent_Conditional_14_For_2_Template, 1, 1, "app-subject-card", 12, _forTrack0);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "mat-paginator", 13);
    \u0275\u0275listener("page", function SubjectListComponent_Conditional_14_Template_mat_paginator_page_3_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r0.subjects());
    \u0275\u0275advance(2);
    \u0275\u0275property("length", ctx_r0.total())("pageSize", ctx_r0.pageSize)("pageIndex", ctx_r0.pageIndex)("pageSizeOptions", \u0275\u0275pureFunction0(4, _c03));
  }
}
var CATEGORIES = ["all", "mandatory", "elective", "major", "minor", "profile"];
var SubjectListComponent = class _SubjectListComponent {
  ...
  ngOnInit() {
    this.searchCtrl.valueChanges.pipe(debounceTime(300), distinctUntilChanged(), startWith(""), takeUntil(this.destroy$)).subscribe(() => {
      this.pageIndex = 0;
      this.fetch();
    });
  }
  ...
  fetch() {
    ...
    this.svc.getAll({
      search: this.searchCtrl.value?.trim() || void 0,
      category: cat === "all" ? void 0 : cat,
      page: this.pageIndex + 1
    }).subscribe({
      next: (res) => {
        this.subjects.set(res.results);
  ...
  static {
    this.\u0275fac = function SubjectListComponent_Factory(t) {
      return new (t || _SubjectListComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SubjectListComponent, selectors: [["app-subject-list"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 15, vars: 3, consts: [[1, "slist", "page-container"], [1, "slist__topbar"], [1, "slist__heading"], [1, "text-muted", 2, "font-size", "1rem", "margin-left", "8px"], ["appearance", "outline", "subscriptSizing", "dynamic", 1, "slist__search"], ["matPrefix", ""], ["matInput", "", "placeholder", "Search subjects\u2026", 3, "formControl"], [1, "slist__tabs"], [1, "slist__tab", 3, "slist__tab--active"], [1, "slist__tab", 3, "click"], [1, "slist__empty"], [1, "slist__grid"], [3, "subject"], [3, "page", "length", "pageSize", "pageIndex", "pageSizeOptions"]], template: function SubjectListComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h1", 2);
        \u0275\u0275text(3, " Subjects ");
        \u0275\u0275template(4, SubjectListComponent_Conditional_4_Template, 2, 1, "span", 3);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(5, "mat-form-field", 4)(6, "mat-icon", 5);
        \u0275\u0275text(7, "search");
        \u0275\u0275elementEnd();
        \u0275\u0275element(8, "input", 6);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(9, "div", 7);
        \u0275\u0275repeaterCreate(10, SubjectListComponent_For_11_Template, 3, 5, "button", 8, \u0275\u0275repeaterTrackByIdentity);
        \u0275\u0275elementEnd();
        \u0275\u0275template(12, SubjectListComponent_Conditional_12_Template, 1, 0, "app-loading-spinner")(13, SubjectListComponent_Conditional_13_Template, 5, 0)(14, SubjectListComponent_Conditional_14_Template, 4, 5);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(4);
        ...
        \u0275\u0275advance(2);
        \u0275\u0275conditional(12, ctx.loading() ? 12 : ctx.subjects().length === 0 ? 13 : 14);
      }
    }, dependencies: [CommonModule, TitleCasePipe, ReactiveFormsModule, DefaultValueAccessor, NgControlStatus, FormControlDirective, MatTabsModule, MatFormFieldModule, MatFormField, MatPrefix, MatInputModule, MatInput, MatIconModule, MatIcon, MatPaginatorModule, MatPaginator, SubjectCardComponent, LoadingSpinnerComponent], styles: ["\n\n.slist[_ngcontent-%COMP%] {\n  padding-top: 24px;\n}\n.slist__topbar[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 16px;\n  flex-wrap: wrap;\n  margin-bottom: 16px;\n}\n.slist__heading[_ngcontent-%COMP%] {\n  font-size: 1.6rem;\n  font-weight: 700;\n  margin: 0;\n  flex: 1;\n}\n.slist__search[_ngcontent-%COMP%] {\n  width: 280px;\n}\n.slist__tabs[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 8px;\n  flex-wrap: wrap;\n  margin-bottom: 20px;\n}\n.slist__tab[_ngcontent-%COMP%] {\n  padding: 6px 18px;\n  border-radius: 20px;\n  border: 1px solid var(--color-border);\n  background: transparent;\n  cursor: pointer;\n  font-size: 0.85rem;\n  font-weight: 500;\n  color: var(--color-text-muted);\n  transition: all var(--transition);\n}\n.slist__tab[_ngcontent-%COMP%]:hover {\n  border-color: var(--color-primary);\n  color: var(--color-primary);\n}\n.slist__tab--active[_ngcontent-%COMP%] {\n  background: var(--color-primary);\n  border-color: var(--color-primary);\n  color: #fff;\n}\n.slist__grid[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: repeat(auto-fill, minmax(260px, 1fr));\n  gap: 16px;\n}\n.slist__empty[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 12px;\n  padding: 60px 0;\n  color: var(--color-text-muted);\n}\n.slist__empty[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 48px;\n  height: 48px;\n  width: 48px;\n}\n/*# sourceMappingURL=subject-list.component.css.map */"], changeDetection: 0 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SubjectListComponent, { className: "SubjectListComponent", filePath: "src\\app\\features\\subjects\\subject-list\\subject-list.component.ts", lineNumber: 30 });
})();
export {
  SubjectListComponent
};
//# sourceMappingURL=chunk-LYVLTIN4.js.map
